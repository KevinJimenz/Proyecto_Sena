    ...
    <body>
        ...
        <main>
            ...
            <aside id="sidebar" class="sidebar expanded">
                ...
                <a class="navegation-button" href="./dashboard-reportes.php">
                    <span class="icon">
                ...
                <a class="navegation-button current-page" href="./dashboard-usuarios.php">
                    <span class="icon">
            ...
            <section id="section" class="section">
                <div class="d-flex justify-content-end">
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary" id="agregar-usuario" data-bs-toggle="modal" data-bs-target="#modal-agregar">Agregar Usuario</button>
                    </div>
                </div>
                <div class="table-responsive">
                    <table id="tabla_usuarios" class="table table-striped" style="width:100%; font-size:20px;">
                    </table>
                </div>
            </section>
                    ...
                    <div class="modal-body">
                        <form id="form-crear">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control onlyText" id="nombre_usuario" name="nombre_usuario" placeholder="Nombre">
                            ...
                            <div class="input-group mb-3">
                                <div class="form-control p-0 border-end-0">
                                    <div class="form-floating">
                                        <input type="password" class="form-control border-0 rounded-start-0 rounded-end-0" id="password_usuario" name="password_usuario" placeholder="Password">
                                        <label for="password_usuario">Contraseña</label>
                                    </div>
                                </div>
                                <div class="input-group-text border-start-0">
                                    <button class="btn p-0 border-0" type="button" id="ocultar-password">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary" id="confirmar-agregacion">Agregar</button>
                            </div>
                        </form>
                    </div>
                </div>
