    ...
    <body>
        ...
        <main>
            <aside id="sidebar" class="sidebar expanded">
                ...
                <a class="navegation-button current-page" href="./dashboard-matrices.php">
                    <span class="icon">
            ...
            <section id="section" class="section">
                <div class="table-responsive">
                    <table id="tabla_matrices" class="table table-striped" style="width:100%; font-size:20px;">
                    </table>
                </div>
            </section>
        ...
        <div class="modal fade" id="modal-detalle" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl"> <!-- Ancho extendido -->
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Detalle de la Matriz</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body"> <!-- Sin padding -->
                        <table id="tabla_detalle" class="table table-striped" style="width: 100%; font-size: 18px;">
                        </table>
                    </div>
                </div>
            </div>
        ...
        <script type="module" src="../../Assets/Js/admin-matrices.js"></script>
    </body>
