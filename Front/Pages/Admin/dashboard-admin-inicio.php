    ...
    <body>
        ...
        <main>
            <aside id="sidebar" class="sidebar expanded">
                <a class="navegation-button current-page" href="./dashboard-admin-inicio.php">
                    <span class="icon">
            ...
            <section id="section" class="section">
                <div class="table-responsive">
                    <table id="tabla_inicio" class="table table-striped" style="width:100%; font-size:20px;">
                    </table>
                </div>
            </section>
        ...
        <script type="module" src="../../Assets/Js/admin-inicio.js"></script>
    </body>
