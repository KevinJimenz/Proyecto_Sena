...
$nombre_archivo = 'Todos_los_instructores.xlsx';
...
$excel->getProperties()
    ...
    ->setDescription("Este archivo contiene el reporte completo de instructores y sus actividades.");
$hojaActiva = $excel->getActiveSheet(); // Obtener la hoja activa
$hojaActiva->setTitle("Reporte Instructores"); // Título de la hoja
